"""Schema-v1 fixture generation sequencer."""
...
from apps.controller.component_runtime import (
    ...
    ControllerError,
    RequestError,
    _component_error_detail,
    _decode_component_output,
    _decode_json,
    _require_component_object,
    _require_exact_keys,
    ...
    def request(self, request: dict[str, object]) -> dict[str, object]:
        ...
        if line == "":
            ...
            if status is not None:
                ...
                detail = _component_error_detail(self.process.stderr.read(), status)
...
def run_generation(
    ...
    try:
        ...
        for index, probe in enumerate(probes):
            ...
            if type(incumbent_model) is not str or incumbent_model != challenger_model:
                raise ControllerError(
...
def run_fixture_generation(source: str) -> dict[str, object]:
...
def decode_document(source: str) -> dict[str, object]:

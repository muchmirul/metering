"""A minimal pairwise evolution transition.
...
def step(
    parent: Candidate[T],
    propose: Callable[[Candidate[T]], Candidate[T]],
    judge: Callable[[Candidate[T], Candidate[T]], Verdict[E]],
) -> Transition[T, E]:
...
__all__ = ["Candidate", "Transition", "Verdict", "step"]

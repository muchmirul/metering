...
the same adapter boundary for future coding-agent clients. Pi is operator,
mutation transport, and UI, never evaluator, selector, ledger authority, worker
runtime, or sandbox boundary.

"""Fixed tool-free Prime Agent connector for one replacement SKILL.md."""
...
def _prime_agent_command(skill_file: Path | None, prompt: str) -> list[str]:
    ...
    try:
        with isolated_configuration():
            return run_main(
                ...
                temporary_prefix="metering-prime-agent-proposer-",
            )
